...
class Dual:
    ...
    def __radd__(self, other: Union['Dual', float]) -> 'Dual': ...
    def __sub__(self, other: Union['Dual', float]) -> 'Dual': ...
    def __rsub__(self, other: Union['Dual', float]) -> 'Dual': ...
    def __mul__(self, other: Union['Dual', float]) -> 'Dual': ...
    def __rmul__(self, other: Union['Dual', float]) -> 'Dual': ...
    def __truediv__(self, other: Union['Dual', float]) -> 'Dual': ...
    def __rtruediv__(self, other: Union['Dual', float]) -> 'Dual': ...
